        ...
        <div className="col-lg-8">
                  ...
                  return (
                    <div key={food.id} className="row cart-item mb-3">
                      ...
                      <div className="col-md-5">
                        ...
                        <p className="text-muted">Categoria: {food.category}</p>
                      </div>
                      ...
                      <div className="col-md-2 text-end">
                        <p className="fw-bold">R$ {(food.price * quantities[food.id]).toFixed(2)}
          ...
          <div className="text-start mb-4">
            <Link to="/" className="btn btn-outline-primary">
              <i className="bi bi-arrow-left me-2"></i>Explorar Mais Produtos
            </Link>
          </div>
        </div>
        ...
        <div className="col-lg-4">
          <div className="card cart-summary">
            <div className="card-body">
              ...
              <button className="btn btn-primary w-100" disabled={cartItems.length === 0}  onClick={() => navigate('/order')}>Finalizar Pedido</button>
            </div>
          </div>
        </div>
      </div>
